...
undefined4
FUN_18001c8c8(ulonglong *param_1,LPWSTR param_2,ulonglong param_3,byte *param_4,ulonglong param_5)

{
  ...
  uVar1 = FUN_18001c5a8(param_1,param_2,param_3,param_4,param_5,local_48);
  if (local_20 == '\x02') {
