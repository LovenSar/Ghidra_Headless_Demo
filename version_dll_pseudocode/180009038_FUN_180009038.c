...
char FUN_180009038(longlong param_1,longlong *param_2,longlong param_3,byte *param_4)

{
  ...
  if ((((*(byte *)(param_3 + 4) & 0x80) == 0) || ((*param_4 & 0x10) == 0)) || (DAT_18003ec30 == 0))
  {
    if ((*(byte *)(param_3 + 4) & 8) == 0) {
      ...
      uVar6 = uVar4;
      if ((*(int *)(param_4 + 0x14) != 8) || (*param_2 == 0)) goto LAB_1800091f9;
      lVar1 = *param_2;
    }
    else {
