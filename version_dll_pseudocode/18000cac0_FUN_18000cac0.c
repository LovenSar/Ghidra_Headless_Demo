...
ulonglong FUN_18000cac0(longlong param_1,byte param_2)
...
LAB_18000cb2b:
  ...
  *(undefined1 *)(param_1 + 0x4c) = 0;
  if (lVar4 == 8) {
    FUN_18000cf80(param_1,uVar3,param_2);
  }
  else {
    FUN_18000cdcc(param_1,(uint)uVar3,param_2);
  }
  uVar2 = *(uint *)(param_1 + 0x28);
  if (((uVar2 >> 7 & 1) != 0) &&
