...
undefined8 *
FUN_180004760(undefined8 *param_1,undefined8 param_2,undefined8 param_3,undefined1 param_4)

{
  ...
  if (_Var8 < 0x1000) {
    ...
    if (pvVar6 == (void *)0x0) goto LAB_1800048b0;
  ...
  if (uVar3 < 0x10) {
    ...
    *(undefined1 *)((longlong)puVar11 + uVar2) = param_4;
    *(undefined1 *)((longlong)puVar11 + uVar2 + 1) = 0;
  }
  else {
