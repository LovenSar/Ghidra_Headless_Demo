...
undefined8 * FUN_180007da0(undefined8 *param_1,undefined8 *param_2,ulonglong param_3)

{
  ...
  if (DAT_18003d0e0 < 3) {
    if ((param_3 < 0x801) || (((byte)DAT_18003ec2c & 2) == 0)) {
      if (0x80 < param_3) {
          ...
          do {
            ...
            *puVar23 = *puVar28;
            ...
            param_3 = param_3 - 0x80;
                    ...
                    /* WARNING: Could not recover jumptable at 0x0001800082b6. Too many branches */
                    /* WARNING: Treating indirect jump as call */
      puVar23 = (undefined8 *)
                (*(code *)((ulonglong)*(uint *)(&DAT_180043088 + (param_3 + 0xf >> 4) * 4) +
                          0x180000000))();
      return puVar23;
    }
  }
  else if (((param_3 < 0x2001) || (0x180000 < param_3)) || (((byte)DAT_18003ec2c & 2) == 0)) {
    uVar10 = *param_2;
    uVar11 = param_2[1];
    uVar32 = param_2[2];
    uVar33 = param_2[3];
        ...
        do {
          ...
          *(undefined8 *)(pauVar24[7] + 0x18) = uVar22;
          ...
          param_3 = param_3 - 0x100;
                    ...
                    /* WARNING: Could not recover jumptable at 0x000180008012. Too many branches */
                    /* WARNING: Treating indirect jump as call */
    puVar23 = (undefined8 *)
              (*(code *)((ulonglong)*(uint *)(&DAT_180043040 + (param_3 + 0x1f >> 5) * 4) +
                        0x180000000))();
    return puVar23;
  }
