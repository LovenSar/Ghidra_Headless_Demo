...

{
  ...
  for (plVar2 = &DAT_18003f750; plVar2 != (longlong *)&DAT_18003f758; plVar2 = plVar2 + 1) {
    if ((undefined **)*plVar2 != &PTR_DAT_18003d350) {
      ppuVar1 = _updatetlocinfoEx_nolock(plVar2,&PTR_DAT_18003d350);
