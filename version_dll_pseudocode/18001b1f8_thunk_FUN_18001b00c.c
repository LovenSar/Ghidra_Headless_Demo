// Function: thunk_FUN_18001b00c
// Address: 18001b1f8


longlong thunk_FUN_18001b00c(uint param_1,LARGE_INTEGER param_2,DWORD param_3,longlong param_4)

{
  ...
  if (hFile == (HANDLE)0xffffffffffffffff) {
    ...
    *(undefined4 *)(param_4 + 0x2c) = 9;
    ...
    if (BVar2 == 0) {
      DVar3 = GetLastError();
      FUN_180010fe0(DVar3,param_4);
    }
    else if (aLStack_18[0].QuadPart != -1) {
      pbVar1 = (byte *)((&DAT_18003f320)[(longlong)(int)param_1 >> 6] + 0x38 +
